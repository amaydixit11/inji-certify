...
//        statusObject.put("id", ledger.getCredentialId());
//        statusObject.put("type", "BitstringStatusListEntry");
////        statusObject.put("type", "CredentialStatusList2017");
//        statusObject.put("statusPurpose", ledger.getStatusPurpose());
//        statusObject.put("statusListIndex", ledger.getStatusListIndex());
//        statusObject.put("statusListCredential", ledger.getStatusListCredentialUrl());
...
//                    if (showCredentialStatus == true) {
//                        jsonObject.put("credentialStatus", new JSONObject(statusObject));
//                    }
                    if (showCredentialStatus) {
                        StatusListCredentials statusList = statusListUpdaterService.findUsableStatusList("revocation", issuerURI);
...
//        Optional<StatusListCredentials> existingList = statusListCredentialRepository
...
//        List<Ledger> issuedCredentials = ledgerRepository
//                .findByIssuerIdAndStatusPurpose(issuerId, statusPurpose);
//
//        StatusListCredentials statusListCredentials = null;
//        try {
//            statusListCredentials = BitStringUtils.generateStatusListCredential(
//                    issuedCredentials,
//                    issuerId,
//                    statusPurpose,
//                    domainUrl,
//                    STATUS_SIZE
//            );
//            statusListCredentialRepository.save(statusListCredentials);
//        } catch (BitstringStatusListException e) {
//            throw new RuntimeException(e);
//        }
//
//        return statusListCredentials.getId();
//    }
